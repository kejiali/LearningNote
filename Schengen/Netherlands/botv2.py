...
print ("Checking for desired Visa: Business for 4 Applicants...")
...
if s.find('No date(s) available for appointment.') == -1:
        ...
        print "Visa: Business for 4 Applicants Appointment available, please go to: 'https://www.vfsvisaonline.com/Netherlands-Global-Online-Appointment_Zone2/AppScheduling/AppWelcome.aspx?P=yLSZQO8Ad673EXhKOPALC%2Fa6TdN5o6wQfJGZex2bh88%3D'"
        headers = {
        ...
        data = '{"Content":"@All Business for 4 Applicants Appointment is available now, please go to https://www.vfsvisaonline.com/Netherlands-Global-Online-Appointment_Zone2/AppScheduling/AppWelcome.aspx?P=yLSZQO8Ad673EXhKOPALC%2fa6TdN5o6wQfJGZex2bh88%3d"}'
        ...
        print "'No date(s) available for appointment.' was Found, so I doubt no appointments for now."
